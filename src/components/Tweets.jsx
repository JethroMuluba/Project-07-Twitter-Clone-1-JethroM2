...
function Tweets () {
    return(
        <div className="tweets">
            ...
            <Tweet tweetAvatar={tweeterAvatar} titleAuthor={"Twitter"} titleDetailAbbr={"@Twitter"} titleDetailHourAndDate={'. Oct 4'} tweetText={'BIG NEWS lol jk still Twitter'} tweetActionReply= {6.8} tweetActionRetweet= {36.6} tweetActionReact= {267.1}/>
            <Tweet tweetAvatar={tweeterAvatar} titleAuthor={"Twitter"} titleDetailAbbr={"@Twitter"} titleDetailHourAndDate={'. Oct 4'} tweetText={'hello literally everyone'} tweetActionReply= {"118.7K"} tweetActionRetweet= {'785.4K'} tweetActionReact= {3.3}/>
            <Tweet tweetAvatar={tweeterAvatar} titleAuthor={"Twitter"} titleDetailAbbr={"@Twitter"} titleDetailHourAndDate={'. Oct 4'} tweetText={'hello literally everyone'} tweetImage={tweetImage} tweetActionReply= {118.5} tweetActionRetweet= {785.4} tweetActionReact= {3.3}/>

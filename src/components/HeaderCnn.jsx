...
export default function HeaderCnn({titleAuthor, titleAuthorAbbr}) {
    ...
    return (
        <header className ="fixed w-[881px] h-[100px] flex gap-[40px] bg-black/60 border-b  border-px border-[#2F3336]  py-[10px] pl-[20px] backdrop-blur z-50 pt-[10px] ">
            ...
            <div className='profile-settings-body'>
                ...
                <p>
                    <span className='text-[1.2rem] font-[50px] text-[#6E767D] '> {titleAuthorAbbr} </span>
                </p>
            </div>
